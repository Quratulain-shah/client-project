    ...
    <div className="bg-gradient-to-b from-[#04122E] to-[#071E41] pt-20 md:pt-32 px-4 md:px-20">
      ...
      <div className="flex flex-col md:flex-row gap-16 items-center md:items-start">
        ...
        <div className="flex flex-col gap-2 mt-10 text-center md:text-left">
          ...
          <h1 className="text-4xl md:text-6xl text-[#00D3F3]">
            Earn Rewards
          </h1>

          <h1 className="text-gray-400 font-semibold text-base md:text-lg mt-6">
            The leading liquid staking protocol for TON. Stake your <br className="hidden md:block" />
            tokens, receive STAKED, and earn rewards while <br className="hidden md:block" />
