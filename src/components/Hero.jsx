...
const Hero = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#092149] via-[#13425E] to-[#0E2E51] flex items-center justify-center">
      <div className="bg-gradient-to-r from-[#092149] via-[#13425E] to-[#0E2E51] pt-20 md:pt-32 container">
