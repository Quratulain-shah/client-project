  ...
  return (
    <div className="pt-10 md:pt-40 px-4 bg-[#0A1536] flex justify-center pb-10">
      <div className="flex flex-col items-center gap-6 md:gap-8 w-full max-w-7xl">
        <div className="flex justify-center items-center gap-2 flex-row w-full max-w-xs h-10 bg-[#07173D] rounded-3xl border border-[#3da9fc] combo">
        ...
        <div className="flex flex-col text-center px-2 combo">
          ...
          <h1 className="text-gray-400 text-base sm:text-lg md:text-xl mt-4 md:mt-6 font-semibold max-w-3xl">
            ...
            institutional investors. Secure, compliant, and scalable liquid
            staking infrastructure.
          </h1>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mt-4 w-full sm:w-auto combo">
        ...
        <div
          className="w-full mt-12 md:mt-14 mb-4 bg-[#040A21] border-t border-b border-gray-700 
                        grid grid-cols-2 sm:grid-cols-4 gap-8 md:gap-24 h-44 justify-center items-center
                        py-8 text-center"
        >
          <div className="flex flex-col points">
            <h1 className="text-[#00B4DD] text-2xl sm:text-3xl md:text-4xl">
              $500M+
            </h1>
          ...
          <div className="flex flex-col points">
            ...
            <h1 className="text-gray-400 text-xs sm:text-sm">Uptime SLA</h1>
          </div>
