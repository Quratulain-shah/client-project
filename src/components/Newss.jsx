    ...
    <div className="flex justify-center bg-gradient-to-b pt-16 md:pt-24 lg:pt-30 from-[#040b24] to-[#0F1B42] px-4">
      <div className="flex flex-col justify-center items-center gap-6 w-full max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full max-w-4xl">
          <div className="flex flex-row w-full h-12 md:h-14 border hover:border-[#219bf8] gap-4 border-gray-700 justify-start items-center p-3 rounded-xl flow">
          ...
          <button
            className="flex justify-center text-center items-center mt-1 bg-gradient-to-r from-[#2983FF] to-[#00CEF3] text-white rounded-xl w-30 h-12"
        ...
        {showAddForm && (
          <div className="flex flex-col gap-2 w-full max-w-4xl p-4 bg-[#071535] rounded-xl border border-[#219bf8] mt-4">
            <input
              type="text"
              placeholder="Title"
              value={newItem.head}
              onChange={(e) => setNewItem({ ...newItem, head: e.target.value })}
              className="p-2 rounded border border-gray-600 bg-[#0C1531] text-white"
            />
            <input
              type="text"
            ...
            <button
              onClick={saveNews}
              className="mt-2 px-4 py-2 bg-[#219bf8] text-white rounded-xl"
            >
        ...
        <div className="flex flex-wrap gap-6 py-6 md:p-10 justify-center md:justify-start w-full blokes">
          {filteredData.map((item, index) => (
            ...
            >
              ...
              <div className="flex justify-between mx-2 mb-2 ">
                ...
                <button
                  className="px-2 py-1 bg-gradient-to-r from-[#2983FF] to-[#00CEF3] text-white rounded-xl font-semibold"
                  onClick={() => {
          ...
          {selectedNews && (
            <div className="fixed inset-0 bg-black/70 flex justify-center items-center z-50">
              <div className="bg-[#0b1b3a] p-6 rounded-xl w-[90%] md:w-[500px]">
                <img
                ...
                <button
                  className="mt-3 px-4 font-semibold py-2 bg-gradient-to-r from-[#2983FF] to-[#00CEF3] text-white rounded-xl"
